            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="p-8 bg-[#0c0d0f] rounded-[2.5rem] border border-white/5 flex items-center justify-between group hover:bg-white/5 transition-all">
                  ...
                  {a.score < 60 ? (
                    <button className="px-6 py-3 bg-red-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all">Isolar da Rede</button>
                  ) : (
