      ...
      <div className="px-6 flex gap-4 mb-8 overflow-x-auto hide-scrollbar shrink-0">
        {[
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest border transition-all whitespace-nowrap ${activeTab === tab.id ? 'bg-gold border-gold text-onyx shadow-xl' : 'bg-white/5 border-white/5 text-zinc-500 hover:text-white'
              }`}
          >
