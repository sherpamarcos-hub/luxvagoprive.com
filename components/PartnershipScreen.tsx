  ...
  if (step === 'success') {
    return (
      <div className="p-10 flex flex-col items-center justify-center text-center space-y-12 animate-in zoom-in-95 min-h-[80vh] bg-[#08090b]">
        ...
        <button onClick={() => window.location.reload()} className="w-full bg-gold text-onyx py-8 rounded-full font-black text-[12px] uppercase tracking-widest shadow-2xl active:scale-95 transition-all">Ativar Protocolos LuxVago</button>
      </div>
    );
  }
